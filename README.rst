...
Prior to creating a pull request, please make sure you do the tests; see the `documentation<https://cg-django-uaa.readthedocs.io/en/latest/developing.html>`_.
